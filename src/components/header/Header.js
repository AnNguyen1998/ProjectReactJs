...
export default function Header() {
  ...
  return (
    <div className='header font_text'>
      <Container fluid>
        <Row className='d-md-none d-lg-flex d-sm-none d-md-flex d-none d-sm-flex' style={{ borderBottom: '1px solid white', padding: '0 100px' }}>
          <Col lg={6}>
        ...
        <Row className='p-2 d-xl-none d-lg-none d-xl-block'>
          ...
          <Col className='d-xl-none d-lg-none d-xl-block'>
            <a href='#'><img src={LiviLogo} width={150} /></a>
          </Col>
          <Col style={{ display: 'flex', justifyContent: 'space-around' }} className='d-xl-none d-lg-none d-xl-block'>
            <BsCart3 style={{ fontSize: '35px', color: 'white' }} />
          </Col>
        </Row>
        <Row style={{ borderBottom: '1px solid white', padding: '20px 10px' }}>
          ...
          <Col xl={3} lg={3} className='d-md-none d-lg-flex d-sm-none d-md-flex d-none d-sm-flex p-2'>
            ...
            <Link href='#' className='icon-la'>
              <BsBagHeart style={{ fontSize: '40px' }} />
              <span className='menu-span'>
